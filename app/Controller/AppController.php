...
class AppController extends Controller {
	public $components = array(
        ...
        function beforeFilter() {
        	...
        	$this->set('bgenres', ClassRegistry::init('Genre')->query('select genres.id, name, count(fg.film_id) as ilosc from genres left join films_genres fg on fg.genre_id=genres.id group by name'));
